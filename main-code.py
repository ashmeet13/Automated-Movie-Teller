...
def fetch_details():
    ...
    print("Enter the path to the mp3 file")
    print("Example : C:/Users/ashme/Desktop/StarWars.mp3")
    file_path = input("Enter here:  ")
    ...
    return city_name,file_path,movie_name
...
city_name,file_path,movie_name = fetch_details()
